...
class HomeExtre extends Component {
    ...
    componentDidMount(){
        const Menu = ()=>{
            ...
            const menu = document.querySelectorAll('.sign')
           ...
           MenuTl.from(menu,{opacity: 0, duration: 1, ease: "slow(100.100, 100.100, false)" , backgroundColor: "purple",stagger: 1.5 ,rotation: 360})

           MenuTl.from(menuHeader,{ duration: 2, ease: "bounce.out", backgroundColor: "red",})
        ...
        const Menu2 = ()=>{
           ...
           MenuTl.from(sign1,{opacity: 0, duration: 1,ease: "slow(100.100, 100.100, false)", xPercent: -100})
           MenuTl.from(sign2,{opacity: 0, duration: 2, ease: "bounce.out", xPercent: 100 })
         MenuTl.from(sign3,{opacity: 0, duration: 3,  ease: "bounce.out" , xPercent: -100 })
         MenuTl.from(sign4,{opacity: 0, duration: 4,ease: "bounce.out"  , xPercent: 10 })
}
